...
<div class="cryptonatorwidget">\
    <div class="">\
		<div class="row calculator-field">\
			<div class="col-md-3 col-sm-6 col-xs-12">\
				<input id="amount-1" type="text" placeholder="Enter amount"' + crypt_calc_font_style + '">\
			</div>\
			<div class="col-md-2 col-sm-6 col-xs-12">\
				<select id="cur-1">' + outList("BTC") + '</select>\
			</div>\
            <div class="col-md-2">\
                <div class="calculator-equal hidden-sm hidden-xs"><span class="equal-1"></span><span class="equal-2"></span></div>\
            </div>\
			<div class="col-md-3 col-sm-6 col-xs-12">\
				<input id="amount-2" type="text" placeholder="Enter amount"' + crypt_calc_font_style + '">\
			</div>\
			<div class="col-md-2 col-sm-6 col-xs-12">\
